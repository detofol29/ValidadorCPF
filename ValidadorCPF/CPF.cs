...
namespace ValidadorCPF
{
    internal class CPF
    {
        ...
        public string ValidarCPF()
        {
            ...
            {
                resultado = "O CPF eh invalido, pois nao possui 11 digitos!";
                return resultado;
            }
            ...
            {
                resultado = "O CPF eh invalido, pois todos os numeros sao iguais!";
                return resultado;
            }

            resultado = "O CPF eh valido!";
            return resultado;
